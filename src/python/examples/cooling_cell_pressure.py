...
#  iterate the cooling solver for a fixed time using a constant pressure
#  model, and output the temperature vs. time.
#
#
...
if __name__ == "__main__":
    ...
    pyplot.legend([p1,p2],["T","$\\mu$"], fancybox=True,
                  loc="center left")
    pyplot.tight_layout()
    pyplot.savefig("cooling_cell_pressure.png")

    # save data arrays as a yt dataset
    yt.save_as_dataset({}, "cooling_cell_pressure.h5", data)
