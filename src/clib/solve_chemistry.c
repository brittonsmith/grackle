...
extern void FORTRAN_NAME(solve_rate_cool_g)(
	...
	int *in, int *jn, int *kn, int *nratec, int *iexpand,
        int *ispecies, int *imetal, int *imcool, int *imcoolonly,
        int *idust, int *idustall,
	...
	int *ih2optical, int *iciecool, int *ithreebody, double *ciecoa,
 	...
 	long long *metDataSize, double *metCooling,
        ...
        int *iisrffield, gr_float* isrf_habing, double *myz);
                          ...
                          double dt_value)
{
  ...
  FORTRAN_NAME(solve_rate_cool_g)(
    ...
    &my_chemistry->metal_cooling_only,
    ...
    &my_chemistry->override_redshift);
