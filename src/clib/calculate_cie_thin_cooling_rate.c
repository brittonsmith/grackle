/***********************************************************************
/
/ Calculate cie optically thin cooling rate
/
/
...
int calculate_cie_thin_cooling_rate(double temp, double *value)
{

  double t_cie[] =
    {4.000d+02,4.040d+02,4.080d+02,4.121d+02,4.162d+02,
  ...
  double cie_table[] =
    {1.435d-15,1.488d-15,1.544d-15,1.601d-15,1.661d-15,
  ...
  if (temp <= t_cie[0]) {
    *value = POW(cie_table[0]*(temp/t_cie[0]), 4);
  ...
  if (temp >= t_cie[287]) {
    *value = POW(cie_table[287]*(temp/t_cie[287]), 3);
